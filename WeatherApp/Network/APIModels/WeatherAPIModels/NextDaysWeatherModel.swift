...
class NextDaysWeatherModel: BaseWeatherModel {
    ...
    override func finalizeParams() {
        self.mainURL += "\(Constants.WEATHER_API_KEYS.NEXT_DAYS_WEATHER_KEY)\(latitude!),\(longitude!).json"
    }
}
